...
class Test_main_enemy_entity(unittest.TestCase):
    ...
    def test_move_to_location(self):
        ...
        self.test_obj = main_enemy_entity.Main_enemy_entity(1 * BLOCK_SIZE, 1 * BLOCK_SIZE, 1)
        self.assertEqual(self.test_obj.move_to_location((128, 128), self.test_group), "bomb")
